                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <select name="ticket_type_id" id="ticket_type_id" class="block mt-1 w-full rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                                    @foreach($ticketTypes as $ticketType)
                                        <option value="{{ $ticketType->type_id }}">{{ $ticketType->type }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div>
                            ...
                            <div class="md:col-span-2">
                             ...
                             <div>
                                ...
                                <x-text-input id="seeker_name" class="block mt-1 w-full" type="text" name="seeker_name" :value="old('seeker_name')" required />
                            </div>
                            <div>
