                    ...
                    <form method="POST" action="{{ route('ticket-types.update', $ticketType) }}">
                        ...
                        <div class="mt-4">
                            <label for="inactive" class="inline-flex items-center">
                                <input id="inactive" type="checkbox" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500" name="inactive" @checked(old('inactive', $ticketType->inactive))>
