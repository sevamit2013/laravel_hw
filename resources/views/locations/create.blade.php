                    ...
                    <form action="{{ route('locations.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <x-input id="loc_code" class="block mt-1 w-full" type="text" name="loc_code" :value="old('loc_code')" required autofocus />
                            </div>
                            <div>
                                <x-label for="location_name" :value="__('Location Name')" />
                                <x-input id="location_name" class="block mt-1 w-full" type="text" name="location_name" :value="old('location_name')" required />
                            </div>
                            <div>
                            ...
                            <div class="flex items-center">
                                <input type="checkbox" name="inactive" id="inactive" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500">
