...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('tickets/{tkt_id}', [TicketController::class, 'show'])->name('tickets.show');
    Route::get('tickets/{tkt_id}/edit', [TicketController::class, 'edit'])->name('tickets.edit');
    Route::put('tickets/{tkt_id}', [TicketController::class, 'update'])->name('tickets.update');
    Route::post('tickets/{tkt_id}/reopen', [TicketController::class, 'reopen'])->name('tickets.reopen');
